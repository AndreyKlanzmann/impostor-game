...
export function GamePlay({ round, players, playerId, onAdvanceToVoting, onGoHome, isHost }: GamePlayProps) {
  ...
  // Ordem de debate aleatória — fixa por round (seed baseado no id da round)
  const debateOrder = useMemo(() => {
    const shuffled = [...players]
    // Embaralha deterministicamente usando o id da round como seed
